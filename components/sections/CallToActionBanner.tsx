...
export default function CallToActionBanner() {
  return (
    <section className="relative w-full max-w-[1770px] mx-auto h-auto min-h-[500px] rounded-[50px] border border-[#343841] bg-gradient-to-r from-[#3245FF] to-[#B845ED] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] flex items-center justify-center px-6 py-16 isolate overflow-hidden">
