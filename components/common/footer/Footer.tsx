...
export default function Footer() {
  return (
    <footer className="w-full bg-[#1D1D21] text-white px-6 md:px-12 lg:px-[110px] py-[80px]">
      {/* Full width instead of max-w constraint */}
      <div className="w-full mx-auto flex flex-col gap-[60px]">
        {/* Top Section */}
        <section className="flex flex-col lg:flex-row justify-between gap-12 w-full">
          {/* Left Block */}
          <div className="flex flex-col gap-8 w-full lg:max-w-[843px]">
            {/* Logo */}
            ...
            <address className="not-italic flex flex-col gap-2 text-[18px] md:text-[19px] leading-[29px] font-manrope font-semibold">
              ...
              <p>
                Contact:{' '}
                <a href="tel:5185643200" className="underline">
                  518-564-3200
                </a>
              </p>
              <p>
            ...
            <nav className="flex gap-6 mt-4 text-[20px]">
              ...
              <a href="mailto:contact@RFBite.com" aria-label="Email">
                <FaEnvelope />
              </a>
            </nav>
          </div>
        ...
        {/* Bottom Section */}
        <section className="flex flex-col md:flex-row justify-between items-center gap-4 w-full text-[18px] md:text-[22px] leading-[33px] font-manrope">
